...
const Services = () => {
    return (
        <>
            <div name="Portfolio" className="Main-container py-10">
                <h1 className="text-5xl font-bold underline text-center">My Portfolio</h1>
                <div className='services-container w-[100%] flex space-x-6 mt-12 px-10 flex-col md:flex-row  '>
